# Bravado Spice — Membership Ownership, and What Debt-to-Equity Conversion Would Do

**Prepared:** August 26, 2026. Sources: the two signed Comatri investment agreements and their Exhibit 2 member schedules (Jul 21–22, 2024 and Nov 20–26, 2024); the Finaloop general ledger (July 22, 2026); QuickBooks; and the Operating Agreement attached to both agreements.

---

## 1. The books cannot tell you who owns what

**Neither accounting system records shares or units.** QuickBooks and Finaloop carry only **capital accounts denominated in dollars**, which track what each member contributed or was allocated — not ownership. Anyone reading them as a cap table would get a badly wrong answer:

| Member | Capital account (Finaloop, Jul 22 2026) | % of total capital | Actual ownership per signed agreements |
|---|---:|---:|---:|
| Jeremiah Tallerine | $202,009.17 | 51.06% | **67.29%** |
| Hugh & Christy Nguyen | $100,000.00 | 25.28% | 18.69% |
| Comatri, Inc. *(titled "Capital – Blake Benthall")* | $54,610.00 | 13.80% | 9.35% |
| Mark Clark | $39,000.00 | 9.86% | 4.67% |

The capital-account view understates the founder's control by **16.2 percentage points** and overstates everyone else's. Ownership is established by the agreements, not the ledgers. (Note also that the ledger labels Comatri's holding under Blake Benthall personally — see `ANALYSIS - Forgiven Loan and Comatri Retitle.md`.)

## 2. The cap table per the signed agreements

**Agreement 1 (executed Jul 21–22, 2024), Exhibit 2 — "Listing of Members," stated as percentages:**
Jeremiah Tallerine 72% · Hugh & Christy Nguyen 20% · Mark Clark 5% · Comatri, Inc. 3% = 100%

**Agreement 2 (executed Nov 20–26, 2024), Exhibit 2 — stated as share counts:**
Jeremiah Tallerine 7,000 · Hugh & Christy Nguyen 2,000 · Mark Clark 500 · Comatri, Inc. 1,000 — **"TOTAL COMPANY SHARES: 10,700."**

**The listed shares sum to 10,500, not 10,700 — the company's own signed document is internally inconsistent by 200 shares.**

**Most likely reconciliation:** the July percentages applied to a 10,000-share base give Jer 7,200, Nguyen 2,000, Clark 500, Comatri 300 — exactly 10,000. Comatri's 700 new shares then produce a 10,700 total and a 1,000-share Comatri position, both of which the November document states. On that reading **Jer holds 7,200 and the November exhibit understates him by 200 shares.** This should be confirmed from the member ledger, not assumed — it is item 30 of the records request.

**Working cap table (reconciled):**

| Member | Shares | Ownership |
|---|---:|---:|
| Jeremiah Tallerine | 7,200 | **67.29%** |
| Hugh & Christy Nguyen | 2,000 | 18.69% |
| Comatri, Inc. | 1,000 | 9.35% |
| Mark Clark | 500 | 4.67% |
| **Total** | **10,700** | 100% |

**Share price, from the agreements themselves:** $15,000 ÷ 300 shares and $35,000 ÷ 700 shares both equal **$50.00 per share** — consistent with Agreement 1's promise of "this same valuation." That implies a company value of **$535,000** at the November 2024 round.

## 3. Conversion scenarios, all priced at the documented $50/share

| Scenario | New shares | Total | **Jer's stake** | Nguyen | Anthony T. | Comatri | Clark |
|---|---:|---:|---:|---:|---:|---:|---:|
| **Today** | — | 10,700 | **67.29%** | 18.69% | — | 9.35% | 4.67% |
| **A.** Nguyen $88,767 + Anthony $69,440 LOC convert | 3,164 | 13,864 | **51.93%** | 27.23% | 10.02% | 7.21% | 3.61% |
| **B.** A + Anthony's new $10,000 loan | 3,364 | 14,064 | **51.19%** | 26.84% | 11.30% | 7.11% | 3.56% |
| **C.** All non-founder member/related debt (adds Clark $25,000, Benthall $8,500) | 4,034 | 14,734 | **48.87%** | 25.62% | 10.78% | 6.79% | 6.79% |
| **D.** C **plus Jer's $176,914 accrued wages** | 7,572 | 18,272 | **58.77%** | 20.66% | 8.70% | 5.47% | 5.47% |

**Answer to "would Jer be in minority?" — only in Scenario C, and only barely.**

- Converting **Hugh's and Anthony's debt alone leaves Jer at 51–52%** — still a majority holder. It is not enough.
- **Jer falls below 50% only if Clark's $25,000 and Blake's $8,500 convert as well** (48.87%).
- The threshold: Jer needs **3,700 new shares — $185,000 of converted debt** — before dropping under 50%, and that is only true if none of his own claims convert.

## 4. The decisive point: the largest convertible claim is the founder's own

**Jer's $176,913.70 of accrued wages is by far the biggest single claim against the company** — larger than Hugh's loan, Anthony's line of credit, Clark's invoices and Blake's bridge loan *combined* ($201,707 total, but spread across four holders). At $50/share it converts to **3,538 shares — more than any other party would receive.**

That inverts the entire exercise. In Scenario D, a "everyone converts their debt to equity" restructuring **raises Jer from 67.29% to 58.77% of a much larger company while diluting every other member**, and leaves the Nguyens — who put in $200,000 cash — at 20.66%.

**So any debt-to-equity proposal must specify, in writing and up front, whether the founder's accrued wages participate.** If they do, conversion consolidates his control. If they don't, it is the only realistic path to reducing it.

## 5. Two governance constraints that matter more than the arithmetic

1. **Operating Agreement §1.9 requires *prior unanimous written consent of the Members* to admit a new member.** Anthony Tallerine is not currently a member. Converting his line of credit to equity would admit him — which **Comatri and the Nguyens can each individually block.** Every scenario above that includes Anthony requires Blake's and Hugh's affirmative written consent.
2. **Agreement 2 ties Comatri's contractual records access to the founder's majority:** the $35,000 bought "access to the Company's financial records from 11/20/2024 **until either Jeremiah Tallerine is no longer a majority stack holder** in the Company or in the event the Investor divests its ownership." On its face, Comatri's *contractual* inspection right terminates if Jer drops below 50%. This does **not** affect the independent statutory rights under TBOC §§3.151, 101.501–101.502 or Operating Agreement §4.6 — but it is an odd clause to have accepted, and counsel should read it before any dilution scenario is agreed to.
