...
| Jan–Feb 2026 | (nothing) | ~**$33K to his personal accounts** in the two strongest collection months (~$17.5K distributions + ~$15.8K unsubstantiated card-bill payments†) — immediately before the cash crisis he blamed entirely on macro conditions and Buc-ee's. |
...
| 2026 totals | — | **~$50K out to Jer or his personal creditors** (Jan–Jul) vs. $3,830 contributed back — of which **$22.7K is unambiguous personal benefit** (distributions + flagged personal items) and **$27.6K is unsubstantiated card-bill payments** (zero itemization; resolvable only by his card statements). Either way, comparable to the ~$50K paid to the **entire remaining team** over the same months. See `ANALYSIS - Reimbursement Legitimacy.md`. |

† *Methodology amendment (Aug 25): all founder-payment figures above were re-derived in `ANALYSIS - Reimbursement Legitimacy.md` against the books' own substantiation machinery. They exclude every documented, itemized reimbursement (~$153K across 2022–2025, undisputed) and the $35,644 of 2024 payments properly charged against accrued wages; within the remaining amounts, fixed transfers to his personal bank accounts and distributions are presumptively personal, while unsubstantiated card-bill payments (~$27K in 2025, $27.6K in 2026) can only be classified from his personal card statements — which is why those statements are in the records request.*
...
6. Has he **ever received a K-1** — and if so, **what form number is printed at the top of it**? This one detail settles the whole tax question in 30 seconds: **"Schedule K-1 (Form 1065)"** means Bravado is taxed as a partnership, where a corporation like Comatri is a perfectly legal owner (so any S election came later, and someone chose it knowing Comatri was a member). **"Schedule K-1 (Form 1120-S)"** means an S election was already running, which a corporate member invalidates. The July doc confirms K-1 filings exist (2024 return: $862,582 gross receipts, $67,869 cash-basis loss), so the documents are out there. And if Hugh — 18.7% — never received one at all, the returns don't match the cap table.
...
9. **About Mark (who introduced Hugh — raise gently, as conflict-of-interest, not accusation):** Has Mark ever disclosed to Hugh that he holds an undisclosed **$25,000 payable** from Bravado, was paid **$82.5K in fees** (2022–25), had his own loans **repaid in full in 2025** while vendors went past due, kept a **"Jer Accts" draw ledger** since Jan 2025 (the same month he wrote "no discretionary cash payments"), and **edited the wage-accrual entry** that the July numbers then excluded? Mark may be a valuable witness — but he cannot be our referee. (Full memo: `ANALYSIS - Mark Clark.md`.)

**Decisions to make together:**
10. A **joint books-and-records demand** under Operating Agreement §4.6 — the keystone items: the December 2025 Finaloop management report + migration workpapers (resolves the $69,033 and the owner-account and liability bridges in one package), complete tax returns/2553/K-1s, bank statements, the July 2026 SBG/Hot Shots correspondence, and the written creditor agreements.
11. **Align on March 2027** — neither of us should answer the loan-resumption request individually, and no further deferral decisions before the records arrive.
12. **Shared counsel** — a closely-held-LLC / investor-misrepresentation litigator. My honest framing: this is not yet a proven fraud case, and we shouldn't call it one; but five written misstatements of existing fact, all favoring the author, all under an "every number is real" warranty, made in support of a specific ask to creditors — that is well past the threshold where lawyers, not just spreadsheets, should be involved.
...
| **Dec 30, 2023 – Jan 6, 2024** | **~$34,610 leaves for Jer's personal credit cards and accounts within eight days of the wire** ($20,910 within ~24 hours). Caveat to state alongside: ~$29K of it was booked as repayment of expenses Jer had fronted — but the sequence (accrue owed-to-founder → investor wire lands → clear founder's personal cards) repeats at every later capital event, and the account then went negative and stayed negative for two years. | |
