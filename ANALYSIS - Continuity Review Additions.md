...
- **Owner-balance netting (errata to `ANALYSIS - Claims vs Books.md` §3.3–3.4).** The Finaloop $157,115.47 opening adjustment equals $88,082.47 + $69,033.00 exactly, so the $69,033 wage accrual may be counted in *both* the owner receivable and payroll payable. Depending on whether that is deliberate migration logic or a double-count, the net founder position at mid-2026 ranges from **Jer owes the company ~$50K** to **the company owes Jer ~$8–19K net**. Either endpoint remains far from the "~$101K net owed to Jer" that (per the memo) the longer July document claimed by netting only the $75,440 "Due from Jer" and ignoring the $88,082 overdrawn account and $5,331 draws. The core finding survives at both endpoints: the sacrifice narrative omits roughly $93K of owner debit balances. *(Further calibration, Aug 25: `ANALYSIS - Reimbursement Legitimacy.md` re-derives every founder-payment figure against the books' own substantiation machinery — the $93K stands, already net of $22,612 in documented reimbursements, splitting into ~$66K presumptively personal and ~$27K pending card-statement classification; $35,644 of 2024 payments were reclassified as legitimate wage paydowns.)* (Note: the longer 8-page July document quoted in the memo is **not in this repo** — only v4 is. Obtain it; its "$75K I have drawn" sentence is a directly testable representation.)
